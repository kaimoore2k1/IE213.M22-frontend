...
import "./Detail_Module.css";
import { initial_products, comment, Product, Comment, related_products } from "./Data";
import Review_images from "./Review_images/Review_images";
        ...
        <section>
            ...
            <div className="description">
                ...
                <div>
                    ...
                    <div id="amount">
                        <div>Số lượng:</div>
                        <button id="sub_button" onClick={()=>{handleSub()}}>-</button>
                        <div>{count}</div>
                        <button id="add_button" onClick={() =>{handleAdd()}}>+</button>
            ...
            <div className="information_and_comment">
                <div className="tab">
                    {tabList.map((tab) => (
                        <div key={tab.id} id={tab.id} onClick={() => onTabChange(tab.id)} >{tab.tab}</div>
                    ))}
                </div>
                <br /><br />
