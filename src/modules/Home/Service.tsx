...
import hospital from "../../modules/assets/hospital.jpg"
import price from "../../modules/assets/price.jpg"
import spa from "../../modules/assets/spa.jpg"
        ...
        <>      
            <section className="home-service-wrapper">
                ...
                <ul className="home-service-ul">
                    <li 
                        className="home-service-item active"
                        onClick={()=> setChange(0)}
                    >
                ...
                <div className="home-service-block  active">
                    <div className="home-service-element ">
                        <img 
                            src={hospital} 
                            alt="dich-vu-kham-benh"
                        />

                        <div className="service-block-des1">
                            <h2 className="service-block-h2">
                                Bệnh viện thú y
                            </h2>
                            <p className="service-block-p">Bệnh viện thú y được trang bị các công nghệ mới nhất. Chúng tôi  phục vụ 24/7 với các đội ngũ nhân viên có trình độ chuyên môn cao để chăm sóc những con lông xù của bạn.</p>
                ...
                <div className="home-service-block  ">
                    <div className="home-service-element">
                        ...
                        <div className="service-block-des1">
                            ...
                            <p className="service-block-p">Sản phẩm đa dạng, nhiều 
                                thể loại và giá cả hợp lí.
                                Cam kết và bảo hành các
                                loại thú cưng giá trị cao. 
                                Chất lượng uy tín đáng để 
                                cạnh tranh lâu dài..</p>
                            <Button type="primary" htmlType="submit">
                                Xem thêm
                            </Button>
                        </div>
