    ...
    return (
        <div className='category'>
            ...
            <Menu
                ...
                style={{ width: 256, borderLeft: "1px solid #c0c0c0", fontSize: 16, fontWeight: 500 }}
                selectedKeys={[!current[2] ? current[1] : current[2]]}
                defaultOpenKeys={[current[1]]}
                mode="inline"
            >
                <SubMenu key="thucung" title={<Menu.Item key="thucung">Thú cưng<Link to={'/thucung'} /></Menu.Item>}>
                ...
                <SubMenu key="thucanthucung" title={<Menu.Item key="thucanthucung">Thức ăn thú cưng<Link to={'/thucanthucung'} /></Menu.Item>}>
                ...
                <SubMenu key="dichvu" title={<Menu.Item key="dichvu">Dịch vụ<Link to={'/dichvu'} /></Menu.Item>}>
