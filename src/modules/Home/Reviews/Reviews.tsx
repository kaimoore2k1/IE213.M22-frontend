...
function Reviews() {
    return (
        <section className="content">
            ...
            <div id="image1">
                <img src={require("./Mision-min-1.png")} alt="image 1" />
                ...
                <img id="footprint1" src={require("./Group-1.png")} alt="" />
            </div>
            <div id="image2">
                <img src={require("./Mision-min-2.png")} alt="image 2" />
                <p id="title2">Bé Bo</p>
                <svg height="100" width="340">
                    <ellipse cx="170" cy="50" rx="170" ry="50" />
                    Sorry, your browser does not support inline SVG.
                ...
                <img id="footprint2" src={require("./Group-2.png")} alt="" />
            </div>
            <div id="image3">
                <img src={require("./Mision-min-3.png")} alt="image 3" />
                ...
                <img id="footprint3" src={require("./Group-1.png")} alt="" />
            </div>
