...
function Hospital() {
  return (
    <div className="Wrapper Hospital">
      ...
      <p>
        Tại Sen Shop, đội ngũ bác sĩ của chúng tôi được đào tạo để nâng cao năng
        lực chuyên môn và làm việc tại bệnh viện với cơ sở vật chất hiện đại
        nhằm duy trì tiêu chuẩn cao trong công tác chăm sóc sức khỏe vật nuôi.
      </p>
      <img
        className="imgCustom"
      ...
      <p>
        ...
        với thú cưng của bạn. Các bệnh thông thường bao gồm: bệnh về hệ hô hấp,
        hệ tiêu hóa, hệ tuần hoàn, tiết niệu, sinh dục, lông da, xương khớp, các
        bệnh về mắt và tai.
      </p>
      <strong>
      ...
      <p>
        ...
        tác chăm sóc vật nuôi. Khi cần thiết, các bác sĩ sẽ tiến hành các phương
        pháp chẩn đoán hình ảnh hoặc làm xét nghiệm để đưa ra hướng điều trị phù
        hợp với thú cưng của bạn.
      </p>
      <strong>
      ...
      <ul>
        ...
        <li>
          <b>Chụp X-quang:</b> máy X-quang thường được dùng để phát hiện các vấn
          đề về xương khớp, khối u, các vật thể lạ trong cơ thể như sỏi thận
          hoặc dị vật đường ruột và chẩn đoán nhiều bệnh khác.
        </li>
      </ul>
      <img
        className="imgCustom"
      ...
      <p>
        ...
        trong trường hợp thú cưng của bạn cần thêm xét nghiệm chuyên khoa khác.
      </p>
      <strong>
      ...
      <strong>
        <p className="pTitle service">Phòng chống kí sinh trùng – Tiêm phòng</p>
      </strong>
      ...
      <p>
        ...
        mèo. Có nhiều cách để phòng ngừa và chữa trị các bệnh lí do chúng gây ra
        tuy nhiên nếu áp dụng không đúng thì quá trình điều trị có thể kéo dài,
        không hiệu quả và gây ảnh hưởng xấu đến sức khỏe thú cưng. Vì vậy chủ
        nuôi cần tham khảo ý kiến bác sĩ trước khi áp dụng bất kì biện pháp
        phòng và chữa bệnh cho thú cưng của mình.
      </p>
      <img
        className="imgCustom"
      ...
      <p>
        ...
        Bệnh gây ảnh hưởng đến sức khỏe và chất lượng cuộc sống của vật nuôi nếu
        không được điều trị sớm. Để phòng ngừa bệnh và hạn chế các tổn thương
        cho vật nuôi do vệ sinh răng chưa đúng cách, Sen Shop cung cấp dịch vụ
        chăm sóc răng miệng (chải răng, kiểm tra lợi và loại bỏ cặn bám làm vàng
        răng) cho chó mèo.
      </p>
      <img
        className="imgCustom"
      ...
      ></img>
      <p>
        Cũng như con người, thú cưng, đặc biệt là chó và mèo cần phải được chăm
        sóc răng miệng thường xuyên. Nếu thấy các biểu hiện sau, vui lòng đem
        thú cưng tới bác sĩ thú y để được kiểm tra và điều trị: <br /> <br />
        Hơi thở hôi.
        <br />
        Đau miệng.
        <br />
