  ...
  return (
    <div className="Wrapper Hotel">
      ...
      <p>
        ...
        hiện đại, thân thiện nhất tại thành phố. Với những dụng cụ chăm sóc cho
        mèo hiện đại, đội ngũ nhân viên được huấn luyện nghiệp vụ tốt, đây sẽ là
        nơi để bạn an tâm gửi gắm thú cưng trong những ngày bận việc hoặc đi
        công tác xa.
        <br />
        Với tình yêu thương đặc biệt với những “ông hoàng, bà thượng”, các dịch
        vụ lưu trú Sen Shop đã chuẩn bị một môi trường đa dạng, thoải mái để
        phục vụ thú cưng.
      </p>
      <img
        className="imgCustom"
      ...
      <ul>
        ...
        <li>
          ...
          đã có kinh nghiệm lâu năm trong việc chăm sóc và trông giữ chó mèo lâu
          năm.
        </li>
      ...
      <p className="moreInfor">
        Để khách hàng yên tâm hơn về dịch vụ lưu trú chó mèo, chim thú, vật cưng
        tại SEN SHOP, chúng tôi luôn chào đón khách hàng ghé đến tham
        quan bất cứ lúc nào. Để đến tham quan vui lòng gọi điện hẹn lịch và tới
        trước 17h hàng ngày, vì sau khoảng thời gian đó, chúng tôi muốn dành
        không gian yên tĩnh nhất cho các bé.
      </p>
    </div>
  );
}
