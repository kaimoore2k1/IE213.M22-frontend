...
function Spa() {
  return (
    <div className="Wrapper Spa">
      ...
      ></img>
      <h2>
        Tại spa thú cưng Sen Shop chúng tôi cung cấp dịch vụ spa thú cưng
        gồm:
      </h2>
      <img
        className="imgCustom"
      ...
      <p>
        ...
        kinh nghiệm của Sen Shop tư vấn màu nhuộm như ý. Thuốc nhuộm là những sản
        phẩm lượng nếu không sẽ gây ảnh hưởng không tốt đến sức khỏe thú cưng.
      </p>
      <img
        className="imgCustom"
      ...
      <p>Gói dịch vụ vệ sinh cơ thể, massage thư giãn kết hợp với các bài tập vận động giúp các bé thoải mái, xả stress.</p>
      <img
        className="imgCustom"
