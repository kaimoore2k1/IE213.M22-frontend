...
import { getBlogBySlug, getHotBlogs } from "../../graphql/schema/blog.graphql";
...
const BlogDetail = () => {
  ...
  const blogs = useQuery(getHotBlogs());
    ...
    <Row className="blog-detail-container">
      ...
      <Col xl={8} md={12} sm={24}>
        {blog.loading ? (
          ...
          <BlogSideCardList
            blogList={blogs.data.getHotBlogs}
